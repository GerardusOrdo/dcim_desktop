...
var
  ...
  pnlTransWidthAwal : Integer;
  pnlTransTopAwal : Integer;
begin
  inherited;
  try
    Animating := True;
    ...
    pnlTransWidthAwal := pnlTrans.Width;
    pnlTransTopAwal := pnlTrans.Top;
  //  AnimateWindow(pnlBottom.Handle, 600, AW_SLIDE or AW_VER_POSITIVE or AW_ACTIVATE);
    Pos := 600;
    pnlTrans.Align := alCustom;
    pnlTrans.Height := pnlTransHeightAwal;
    pnlTrans.Width := pnlTransWidthAwal;
    pnlTrans.Top := pnlTransTopAwal;
